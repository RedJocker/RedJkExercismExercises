      ...
      *-------- "missing the letter 'x'"                                        
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "missing the letter 'x'"                                        
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE 'a quick movement of the enemy will jeopardize five gun        
      -    'boats' TO WS-SENTENCE                                               
            PERFORM PANGRAM                                                     
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
           SET UT-NUMERIC-COMPARE TO TRUE                                       
      ...
      *-------- "with underscores"                                              
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "with underscores"                                              
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE 'the_quick_brown_fox_jumps_over_the_lazy_dog' TO                
               WS-SENTENCE                                                      
            PERFORM PANGRAM                                                     
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "with numbers"                                                  
           ...
           MOVE "with numbers"                                                  
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE 'the 1 quick brown fox jumps over the 2 lazy dogs' TO           
               WS-SENTENCE                                                      
            PERFORM PANGRAM                                                     
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "missing letters replaced by numbers"                           
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "missing letters replaced by numbers"                           
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE '7h3 qu1ck brown fox jumps ov3r 7h3 lazy dog' TO                
               WS-SENTENCE                                                      
            PERFORM PANGRAM                                                     
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "mixed case and punctuation"                                    
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "mixed case and punctuation"                                    
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE '"Five quacking Zephyrs jolt my wax bed."' TO                   
               WS-SENTENCE                                                      
            PERFORM PANGRAM                                                     
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "case insensitive"                                              
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "case insensitive"                                              
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE 'the quick brown fox jumps over with lazy FX' TO                
               WS-SENTENCE                                                      
            PERFORM PANGRAM                                                     
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
           ...
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-AFTER-EACH                                                
      *-------- "a-m and A-M are 26 different characters but not a pangr        
      * am"                                                                     
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "a-m and A-M are 26 different characters but not a pangr        
      -    "am"                                                                 
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
      ...
      * CCHECKPARAGRAPHSPD.CPY END                                              
        PANGRAM.                                                                
           ...
           PERFORM COUNT-CHAR VARYING LS-IDX FROM 1 BY 1 UNTIL LS-IDX >         
               60                                                               
            IF IS-PANGRAM THEN                                                  
                MOVE 1 TO WS-RESULT                                             
            END-IF.                                                             
