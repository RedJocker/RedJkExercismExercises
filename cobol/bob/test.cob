      ...
      *-------- "asking a question"                                             
           ...
           MOVE "asking a question"                                             
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE "Does this cryogenic chamber make me look fat?" TO              
               WS-HEYBOB                                                        
            PERFORM BOB                                                         
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "asking a numeric question"                                     
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "asking a numeric question"                                     
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
      ...
      *-------- "using acronyms in regular speech"                              
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "using acronyms in regular speech"                              
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE "It's OK if you don't want to go work for NASA." TO             
               WS-HEYBOB                                                        
            PERFORM BOB                                                         
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "shouting with special characters"                              
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "shouting with special characters"                              
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE "ZOMG THE %^*@#$(*^ ZOMBIES ARE COMING!!11!!1!" TO              
               WS-HEYBOB                                                        
            PERFORM BOB                                                         
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "shouting with no exclamation mark"                             
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "shouting with no exclamation mark"                             
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
      ...
      *-------- "statement containing question mark"                            
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "statement containing question mark"                            
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
      ...
      *-------- "non-letters with question"                                     
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "non-letters with question"                                     
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE ":) ?" TO WS-HEYBOB                                            
            PERFORM BOB                                                         
      ...
      *-------- "multiple line question"                                        
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "multiple line question"                                        
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE "Does this cryogenic chamber make me look fat? NO." TO          
               WS-HEYBOB                                                        
            PERFORM BOB                                                         
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "ending with whitespace"                                        
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "ending with whitespace"                                        
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE "Okay if like my  spacebar  quite a bit?   " TO                 
               WS-HEYBOB                                                        
            PERFORM BOB                                                         
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      *-------- "non-question ending with whitespace"                           
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "non-question ending with whitespace"                           
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
           MOVE "This is a statement ending with whitespace      " TO           
               WS-HEYBOB                                                        
            PERFORM BOB                                                         
           ADD 1 TO UT-TEST-CASE-COUNT                                          
           SET UT-NORMAL-COMPARE TO TRUE                                        
      ...
      * CCHECKPARAGRAPHSPD.CPY END                                              
        ...
        PARSE-BLANK.                                                            
           PERFORM VARYING IDX FROM 1 BY 1 UNTIL IDX > 60 OR                    
               IS-NOT-BLANK                                                     
                ...
                END-IF                                                          
            END-PERFORM                                                         
      *                              IDX IS SET FOR PARSE-SENTENCE CONTI        
      * NUATION                                                                 
            COMPUTE IDX = IDX - 1.                                              
