      ...
      *-------- "ROT1"                                                          
           ...
           SET UT-ALPHANUMERIC-COMPARE TO TRUE                                  
           MOVE WS-CIPHER TO UT-ACTUAL                                          
           MOVE 'BCDEFGHIJKLMNOPQRSTUVWXYZA'                                    
               TO UT-EXPECTED                                                   
           SET UT-RELATION-EQ TO TRUE                                           
           PERFORM UT-CHECK-EXPECTATION                                         
           MOVE SPACES                                                          
      ...
      *-------- "ROT13"                                                         
           ...
           SET UT-ALPHANUMERIC-COMPARE TO TRUE                                  
           MOVE WS-CIPHER TO UT-ACTUAL                                          
           MOVE 'NOPQRSTUVWXYZABCDEFGHIJKLM'                                    
               TO UT-EXPECTED                                                   
           SET UT-RELATION-EQ TO TRUE                                           
           PERFORM UT-CHECK-EXPECTATION                                         
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-AFTER-EACH                                                
      *-------- "ROT5 Capital Letters"                                          
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "ROT5 Capital Letters"                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE 5 TO WS-KEY                                                    
            MOVE 'OMG' TO WS-TEXT                                               
      ...
      *-------- "ROT13 Quick Fox"                                               
           ...
           SET UT-ALPHANUMERIC-COMPARE TO TRUE                                  
           MOVE WS-CIPHER TO UT-ACTUAL                                          
           MOVE "GUR DHVPX OEBJA SBK WHZCF BIRE GUR YNML QBT."                  
               TO UT-EXPECTED                                                   
           SET UT-RELATION-EQ TO TRUE                                           
           PERFORM UT-CHECK-EXPECTATION                                         
           MOVE SPACES                                                          
      ...
      * CCHECKPARAGRAPHSPD.CPY END                                              
        ...
        ROTATE-CHAR.                                                            
           ...
           COMPUTE LS-PLAIN-CHAR-NUM = FUNCTION ORD(WS-PLAIN-CHAR(IDX))         
               - LS-CASE-CODE-OFFSET                                            
           COMPUTE LS-CIPHER-CHAR-NUM = FUNCTION MOD(LS-PLAIN-CHAR-NUM +        
               WS-KEY, 26)                                                      
            SET UPPER-OFFSET TO TRUE                                            
           MOVE FUNCTION CHAR(LS-CIPHER-CHAR-NUM + LS-CASE-CODE-OFFSET)         
               TO WS-CIPHER-CHAR(IDX).                                          
