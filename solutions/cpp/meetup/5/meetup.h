...
namespace meetup {
	...
	class scheduler {
		...
		boost::gregorian::date xteenth(short unsigned int weekday) const;
		boost::gregorian::date first_x(short unsigned int weekday) const;
		boost::gregorian::date second_x(short unsigned int weekday) const;
		boost::gregorian::date third_x(short unsigned int weekday) const;
		boost::gregorian::date fourth_x(short unsigned int weekday) const;
		boost::gregorian::date last_x(short unsigned int weekday) const;

	public:
		scheduler(boost::date_time::months_of_year ,short unsigned int year);
