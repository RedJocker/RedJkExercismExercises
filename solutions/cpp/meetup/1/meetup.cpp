...
namespace meetup {
	...
	boost::gregorian::date scheduler::xteenth(int weekday) const {
		int day = 13;
		while (true) {
	...
	boost::gregorian::date scheduler::first_x(int weekday) const {
		int day = 1;
		while (true) {
	...
	boost::gregorian::date scheduler::second_x(int weekday) const {
	...
	boost::gregorian::date scheduler::third_x(int weekday) const {
		boost::gregorian::date first = this->first_x(weekday);
	...
	boost::gregorian::date scheduler::fourth_x(int weekday) const {
		boost::gregorian::date first = this->first_x(weekday);
	...
	boost::gregorian::date scheduler::last_x(int weekday) const {
		int day = this->date.end_of_month().day();
		while (true) {
