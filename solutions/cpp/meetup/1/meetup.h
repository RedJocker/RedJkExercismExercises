...
namespace meetup {
	...
	class scheduler {
		...
		boost::gregorian::date xteenth(int weekday) const;
		boost::gregorian::date first_x(int weekday) const;
		boost::gregorian::date second_x(int weekday) const;
		boost::gregorian::date third_x(int weekday) const;
		boost::gregorian::date fourth_x(int weekday) const;
		boost::gregorian::date last_x(int weekday) const;
